...
#   //xla/backends/gpu/codegen/metal_kernels:metalblas_shaders EMBEDS via xxd (one
...
#   MB_TOKCLAMP patch in workspace.bzl), so "verbatim" holds by construction rather
