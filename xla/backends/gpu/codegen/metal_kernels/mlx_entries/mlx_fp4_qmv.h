...
// at its definition with what diverges and why, and //third_party/mlx:workspace.bzl
...
// for the WHOLE function -- the hot unrolled loop included. These impls
// previously carried it behind a `k_aligned` template
...
// workspace.bzl patch: see that file's note -- our forks below supersede upstream's
