...
#include "xla/service/gpu/llvm_gpu_backend/metal_air_backend.h"
#include "xla/shape.h"
...
void ScrubAirIncompatibleAttrs(llvm::Module& module) {
  ...
  for (llvm::Function& fn : module.functions()) {
    ...
    // The AIR warp and barrier builtins must stay Convergent, or air-opt
    // reorders code across them and reductions go silently wrong.
