...
// Fusions that lower GEMMs through the Fly/FlyROCDL MLIR dialects.
inline constexpr absl::string_view kFlyGemmFusionKind = "__fly_gemm";
inline constexpr absl::string_view kFlyGemvFusionKind = "__fly_gemv";
