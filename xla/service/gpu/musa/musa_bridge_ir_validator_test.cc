...
TEST(MusaBridgeIrValidatorTest, AcceptsS4000Architecture) {
  MusaBridgeIrMetadata metadata = Metadata();
  metadata.architecture = kMusaS4000TargetArchitecture;
  EXPECT_THAT(Validate(MinimalModule(), metadata), IsOk());
}
