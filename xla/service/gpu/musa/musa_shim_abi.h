...
inline constexpr uint32_t kMusaShimMappingVersion = 4;
inline constexpr uint32_t kMusaInterchangePointerWidth = 64;
inline constexpr bool kMusaInterchangeIsLittleEndian = true;
// Mapping v4 extends the v3 instruction contract to the qualified mp_22
// target. It admits exactly one atomic instruction shape. Both bridge
...
inline constexpr auto& kMusaS4000TargetArchitecture =
    stream_executor::musa::kS4000TargetArchitecture;
inline constexpr auto& kMusaDataLayout =
    stream_executor::musa::kMusaTargetDataLayout;

inline constexpr bool IsSupportedMusaTargetArchitecture(
    absl::string_view architecture) {
  return architecture == kMusaTargetArchitecture ||
         architecture == kMusaS4000TargetArchitecture;
}
...
inline constexpr char kMusaShimMappingSha256[] =
    "5ec943740d2fd8cb3ce55854aaee55670cda60d85bdb29f7396b4de25b96bf42";
