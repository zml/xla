// MLX steel split-K GEMM, flattened from the MLX repo (MIT License,
// Copyright (c) 2023 Apple Inc., https://github.com/ml-explore/mlx) by
// /tmp/flatten_mlx_splitk.py over mlx @ the 2026-06 tree: the include chain of
//   mlx/backend/metal/kernels/steel/gemm/kernels/steel_gemm_splitk.h
// inlined include-once, repo layout preserved in the begin/end markers.
// DO NOT EDIT between the markers; regenerate from the mlx tree instead.
//
...
// Stamped per shape via __TOKEN__s below, like the other bundle families.
...
// ===== end mlx/backend/metal/kernels/steel/gemm/kernels/steel_gemm_splitk.h =====
