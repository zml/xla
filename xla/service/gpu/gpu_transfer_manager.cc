...
static std::unique_ptr<xla::TransferManager> CreateMUSATransferManager() {
  return std::make_unique<xla::gpu::GpuTransferManager>(
      /*id=*/stream_executor::musa::kMusaPlatformId,
      /*pointer_size=*/llvm::DataLayout(xla::gpu::musa::DataLayout())
          .getPointerSize(0 /* default address space */));
}
...
static bool InitModule() {
  ...
  xla::TransferManager::RegisterTransferManager(
      stream_executor::musa::kMusaPlatformId, &CreateMUSATransferManager);
  return true;
}
