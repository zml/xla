...
#ifndef XLA_STREAM_EXECUTOR_GPU_HOST_CALLBACK_REGISTRY_H_
#define XLA_STREAM_EXECUTOR_GPU_HOST_CALLBACK_REGISTRY_H_
...
// The registry deliberately avoids using vendor APIs directly and instead
// accepts callbacks for scheduling and status checking, which keeps it testable
...
class HostCallbackRegistry {
 public:
  ...
  class RegistryHandle {
   public:
    ...
    explicit RegistryHandle(HostCallbackRegistry* absl_nonnull
 ...
 private:
  ...
  std::shared_ptr<RegistryHandles> GetCurrentStreamCallbackRegistries();
...
#endif  // XLA_STREAM_EXECUTOR_GPU_HOST_CALLBACK_REGISTRY_H_
