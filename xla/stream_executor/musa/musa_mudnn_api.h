...
// shim. The normalized adapter is qualified against the exact vendor versions
// shipped by the supported SDK 4 and SDK 5.1 redistributions.
inline constexpr char kMusaMuDnnAbiContractV1[] =
    ...
    "convolution=forward,backward-data,backward-filter;mudnn=2.8.0,3.3.0";
inline constexpr char kMusaMuDnnAbiFingerprintV1[] =
    "1962f404d1002d9d4b3dadb22c1e41603647ece58a83cfe94336ba3b4b729830";
