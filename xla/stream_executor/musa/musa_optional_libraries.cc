...
GetAvailableMusaOptionalLibraryAbis() {
  ABSL_ASSIGN_OR_RETURN(std::vector<MusaOptionalLibraryAbi> mublas,
                      GetAvailableMusaMuBlasOptionalLibraryAbis());
  ABSL_ASSIGN_OR_RETURN(std::vector<MusaOptionalLibraryAbi> mufft,
                      GetAvailableMusaMuFftOptionalLibraryAbis());
  ABSL_ASSIGN_OR_RETURN(std::vector<MusaOptionalLibraryAbi> mudnn,
