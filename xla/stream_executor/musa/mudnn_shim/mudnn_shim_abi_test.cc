...
TEST(MuDnnShimAbiTest, CapabilityBitsAreAppendOnlyAndComplete) {
  ...
  // The BF16 type value remains reserved, but the qualified shim contract does
  // not advertise executable BF16 support until every supported stack passes
  // the corresponding convolution probes.
