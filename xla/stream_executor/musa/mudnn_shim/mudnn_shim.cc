...
static_assert(
    (MUDNN_VERSION_MAJOR == 2 && MUDNN_VERSION_MINOR == 8 &&
     MUDNN_VERSION_PATCH == 0) ||
        (MUDNN_VERSION_MAJOR == 3 && MUDNN_VERSION_MINOR == 3 &&
         MUDNN_VERSION_PATCH == 0),
    "muDNN shim supports only the qualified 2.8.0 and 3.3.0 header ABIs");
